					...
					<div class="row">
						<aside class="col-md-3">
							<div class="side-widget">
								...
								<ul class="shop-cat">
									<c:forEach var="categoria" items="${categorie}">
										<li><a href="./shop_single_full.html">${categoria.nome}
							...
							<div class="side-widget">
								...
								<ul class="recent-products">
									<li><img src="img/shop/1/1.png" alt="" />
										<div class="rpp-info">
											<a href="./shop_single_full.html">Lorem ipsum is simp</a>
									...
									<li><img src="img/shop/1/2.png" alt="" />
										<div class="rpp-info">
											<a href="./shop_single_full.html">Lorem ipsum is simp</a>
											<div class="rc-ratings">
												<span class="fa fa-star active"></span> <span
									...
									<li><img src="img/shop/1/3.png" alt="" />
										<div class="rpp-info">
											<a href="./shop_single_full.html">Lorem ipsum is simp</a>
											<div class="rc-ratings">
												<span class="fa fa-star active"></span> <span
						...
						<div class="col-md-9">
							<div class="shop-grid">
								...
								<div class="sg-list">
									<a href="./shop_left_sidebar.html"><i
										class="fa fa-th-large"></i></a> <a
										href="./shop_right_sidebar.html"><i class="fa fa-reorder"></i></a>
								</div>

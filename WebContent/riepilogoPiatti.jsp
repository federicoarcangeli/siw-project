							...
							<table class="cart-table table table-bordered">
								...
								<tbody>
									<tr>
										...
										<td><a href="./shop_single_full.html"><img
												src="img/shop/1.png" alt="" height="90" width="90"></a></td>
										<td><a href="./shop_single_full.html">Delicious Food
												Name</a></td>
									...
									<tr>
										<td><a href="#" class="remove"><i class="fa fa-times"></i></a></td>
										<td><a href="./shop_single_full.html"><img
												src="img/shop/2.png" alt="" height="90" width="90"></a></td>
										<td><a href="./shop_single_full.html">Dry fruit Food
												Name</a></td>
										<td><span class="amount">£119.99</span></td>
										<td>
											<div class="quantity">1</div>
										</td>
										<td><span class="amount">£119.99</span></td>
										...
										<td colspan="6" class="actions">
											<div class="col-md-6">
												<div class="coupon form-group">
													<label>Coupon:</label> <br> <input
														placeholder="Coupon code" class="form-control" type="text">
								...
								<div class="col-md-6 push-md-6 no-padding">
									...
									<table class="table table-bordered col-md-6">
										<tbody>
											...
											<tr>
												<th>Order Total</th>
												<td><strong><span class="amount">£190.00</span></strong>
												</td>
											</tr>
										</tbody>
									</table>

								...
								<div class="col-md-4 col-sm-6">
									<div class="form-group">
										<label for="datepicker">Data</label> <input type="text"
											...
											value='${param["data"]}'> <i class="fa fa-calendar-o"></i>
									</div>
								</div>
								<div class="col-md-4 col-sm-6">
									<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-md-4  col-sm-6">
					...
					<div class="footer-blog clearfix">
						<a href="./blog_right_sidebar.html"> <img src="img/thumb8.png"
							class="img-responsive footer-photo" alt="blog photos">
					...
					<div class="footer-blog clearfix last">
						<a href="./blog_right_sidebar.html"> <img src="img/thumb9.png"
							class="img-responsive footer-photo" alt="blog photos">
							<p class="footer-blog-text">Daily special foods that you will
								going to love</p>
							<p class="footer-blog-date">29 may 2015</p>
						</a>
					</div>

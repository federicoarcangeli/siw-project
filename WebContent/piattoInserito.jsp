...
<head>
<meta charset="utf-8">
<title>Un nuovo piatto &egrave stato inserito nel men&ugrave</title>
				...
				<div class='row'>
					<div class='col-md-12 text-center'>
						<div class='giant-space'>
							...
							<h2 class='animated fadeInUp'>Piatto inserito</h2>
							<p class='wow fadeInUp'>Nome: ${param["nome"]}</p>
							<p class="wow fadeInUp">Descrizione: ${param["descrizione"]}</p>
							<p class="wow fadeInUp">Prezzo: ${param["prezzo"]}</p>
							<img src='${requestScope["message"]}' class="img-responsive footer-photo"
									alt="blog photos">

							<h3>${requestScope["message"]}</h3>

							<a href="./inserimentoPiatti.jsp">Inserisci un altro piatto
								nel men&ugrave</a>
						</div>
					</div>
				</div>

package it.uniroma3.project.filter;
...
import it.uniroma3.project.controller.UtenteControllerBean;
...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		UtenteControllerBean loginBean = (UtenteControllerBean) ((HttpServletRequest) request).getSession().getAttribute("loginBean");
		...
		if (loginBean == null || !loginBean.isLoggedIn()) {
			...
			((HttpServletResponse) response).sendRedirect(contextPath + "/administrator.jsp");
		}
